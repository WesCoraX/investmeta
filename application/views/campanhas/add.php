            ...
            <?php echo form_open('campanhas/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="cam_investimento" class="control-label">Investimento Inicial</label>
					...
					<div class="col-md-6">
						<label for="cam_objetivo" class="control-label">Objetivo Final</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="cam_inicio" class="control-label">Data Inicio</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="cam_fim" class="control-label">Data Final</label>
						<div class="form-group">
							<input type="text" name="cam_fim" value="<?php echo $this->input->post('cam_fim'); ?>" class="has-datepicker form-control" id="cam_fim" />
						</div>
					</div>
                    <div class="col-md-6">
                        <label for="cam_nome" class="control-label">Nome da campanha</label>
                        <div class="form-group">
